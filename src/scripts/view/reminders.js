...
const reminders = async _ => {
        ...
        db.removeFromReminders(id)
            .then(_ => {
                ...
                swal("Success to remove", "The match has been removed from reminders!", "success")
                    .then(async _ => {
                        const tabelMatchesElement = document.querySelector('table-matches');
                        tabelMatchesElement.remove();
                        await reminderData();
                    })
            })
    }
    ...
    async function reminderData() {
        await db.getAll().then(async reminders => {
